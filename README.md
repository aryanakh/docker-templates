# unRAID Docker Templates for Docker images in the "aryankh" repository.
...
2. Enter in a URL of https://github.com/aryanakh/docker-templates in the "Template repositories" field
